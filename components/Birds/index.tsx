    ...
    <div className="absolute left-0 right-0 bottom-0 top-0 z-[-1]">
      ...
      <div className="w-full h-full relative">
        ...
        <div className="absolute left-0 right-[95%] bottom-0 top-0">
          <div className="w-full h-full bg-gradient-to-r from-white absolute"></div>
        </div>
        {/* RIGHT BORDER */}
        <div className="absolute right-0 left-[95%] bottom-0 top-0">
          <div className="w-full h-full bg-gradient-to-l from-white absolute"></div>
        </div>
        {/* TOP BORDER */}
        <div className="absolute right-0 left-0 bottom-[90%] top-0">
          <div className="mt-16 w-full h-full bg-gradient-to-b from-white absolute"></div>
        </div>
        {/* BOTTOM BORDER */}
